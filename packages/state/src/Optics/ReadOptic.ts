import { OpticType, total, DeriveOpticType, FocusedValue } from '@optics/core';
...
export type Dependency = {
    state?: any;
    optic: _ReadOptic<any, OpticType>;
    unsubscribe: () => void;
...
export type ReadOpticDeriveFromProps<A, TOpticType extends OpticType, T = NonNullable<A>> = T extends Record<any, any>
    ? {
          [P in keyof T as T[P] extends Function ? never : P]-?: ReadOptic<T[P], DeriveOpticType<A, TOpticType>>;
      }
    : {};
