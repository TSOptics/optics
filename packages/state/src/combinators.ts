import { OpticType, PureOptic } from '@optix/core';
import { ComposedOpticType, IsAny, IsNullable, mapped, partial, ToPartial, total } from '@optix/core/src/types';
...
export type Resolve<TOptic, A, TOpticType extends OpticType, S> = [TOptic] extends [{ setAsync(a: any): any }]
    ? AsyncOptic<A, TOpticType, S>
    : [TOptic] extends [{ set(a: any): any }]
    ? Optic<A, TOpticType, S>
    : [TOptic] extends [{ getAsync(): any }]
    ? AsyncReadOptic<A, TOpticType, S>
    : ReadOptic<A, TOpticType, S>;
